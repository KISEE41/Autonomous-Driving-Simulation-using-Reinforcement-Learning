...
class PerspectiveTransformation:
    ...
    def __init__(self):
        ...
        self.src = np.float32([(200, 100),      # top-left
                               (20, 200),       # bottom-left
                               (480, 200),      # bottom-right
                               (300, 100)])       # top-right    


        self.dst = np.float32([(30, 0),
                               (30, 200),
                               (470, 200),
                               (470, 0)])
    ...
    def forward(self, img, img_size=(500, 200), flags=cv2.INTER_LINEAR):
    ...
    def backward(self, img, img_size=(500, 200), flags=cv2.INTER_LINEAR):
